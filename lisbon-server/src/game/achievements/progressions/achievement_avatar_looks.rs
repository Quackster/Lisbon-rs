//! Mirrors `net.h4bbo.lisbon.game.achievements.progressions.AchievementAvatarLooks`.
...
pub struct AchievementAvatarLooks;

impl AchievementProgress for AchievementAvatarLooks {
