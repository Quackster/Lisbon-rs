//! Mirrors `net.h4bbo.lisbon.game.commands.clientside.FurniCommand`.

use crate::game::commands::command::Command;
use crate::game::entity::entity::Entity;
use crate::game::fuserights::fuseright::Fuseright;

/// Mirrors `FurniCommand` (client-side, `handleCommand` is a no-op).
pub struct FurniCommand {
    permissions: Vec<Fuseright>,
    arguments: Vec<String>,
}

impl Command for FurniCommand {
    ...
    fn get_description(&self) -> String {
        "List furniture in current room (club membership required)".to_string()
    }
