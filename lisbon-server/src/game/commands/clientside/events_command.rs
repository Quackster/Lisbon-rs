//! Mirrors `net.h4bbo.lisbon.game.commands.clientside.EventsCommand`.

use crate::game::commands::command::Command;
use crate::game::entity::entity::Entity;
use crate::game::fuserights::fuseright::Fuseright;

/// Mirrors `EventsCommand` (client-side, `handleCommand` is a no-op).
...
impl Command for EventsCommand {
    ...
    fn get_description(&self) -> String {
        "Show current events organised by other users".to_string()
    }
