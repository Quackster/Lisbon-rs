//! Mirrors `net.h4bbo.lisbon.game.games.battleball.powerups.VacuumHandle`.
use std::sync::Arc;
...
impl VacuumHandle {
    ...
    pub fn handle(
    ...
    ) {
        {
            ...
            player.set_player_state(BattleBallPlayerState::CleaningTiles);
        }
        ...
        GameScheduler::get_instance().schedule(
            {
                ...
                move || {
                    ...
                    if game_player
                        .lock()
                        .get_player_state()
                        != BattleBallPlayerState::CleaningTiles
                    {
                        return;
                    }
