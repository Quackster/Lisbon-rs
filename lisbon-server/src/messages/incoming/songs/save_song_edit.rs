//! Mirrors `net.h4bbo.lisbon.messages.incoming.songs.SAVE_SONG_EDIT`.
...
use crate::messages::outgoing::songs::song_update::SONG_UPDATE;
use crate::messages::types::MessageEvent;
use crate::server::netty::streams::NettyRequest;
use crate::util::string_util::StringUtil;

#[allow(non_camel_case_types)]
pub struct SAVE_SONG_EDIT;

impl MessageEvent for SAVE_SONG_EDIT {
