//! Mirrors `net.h4bbo.lisbon.messages.incoming.rooms.user.USER_START_TYPING`.
...
pub struct USER_START_TYPING;

impl MessageEvent for USER_START_TYPING {
    ...
    fn handle(&self, player: &Player, _reader: &mut NettyRequest) -> Result<(), String> {
        ...
        room_user.begin_chat_bubble_timer();
        room_user.set_typing(true);
